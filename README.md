...
<p align="center">
<img src="https://latex.codecogs.com/png.image?\bg{white}\sum_{i=1}^n{\[y^{(i)}(\bar{w}\cdot\bar{x}^{(i)})\leq&space;0]}"/>
</p>
...
<p align="center">
<img src="https://latex.codecogs.com/png.image?\bg{white}\sum_{i=1}^n{\max(1-y^{(i)}(\bar{w}\cdot\bar{x}^{(i)}),&space;0)}"/>
</p>
