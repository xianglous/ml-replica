...
def evaluate(filename, x_cols, y_col, method, lr=1e-5, tol=1e-3, max_iter=1000):
    print("==========================")
    start = time.time()
    ...
    print(model_str(x_cols, y_col, True)+f" using {method}")
...
if __name__ == "__main__":
    ...
    for x_cols in features:
        evaluate("../Data/binary_classification.csv", x_cols, y_col, 'SGD')
    for x_cols in features:
        evaluate("../Data/binary_classification.csv", x_cols, y_col, 'GD')
    for x_cols in features:
        evaluate("../Data/binary_classification.csv", x_cols, y_col, 'closed-form')